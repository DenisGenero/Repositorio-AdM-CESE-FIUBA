...
from Correlation_Intrinsic import vecCorr_Intr
...
#ax[1].plot(samples, vecCorr_Intr, color="olive")
#ax[1].plot(samples, vecCorr_ASM, color="violet", marker=".")
#ax[1].plot(samples, vecCorr_DSP, color="blue", marker=".")
#ax[1].legend(["vecCorrPy", "vecCorr_C", "vecCorr_Intr", "vecCorr_ASM", "vecCorr_DSP"])
#plt.show()
